...
type RegisterRequest struct {
	...
	Phone    string `protobuf:"bytes,1,opt,name=phone,proto3" json:"phone,omitempty"`       // phone number of the user to register
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // password of the user to register
	Feed     int64  `protobuf:"varint,3,opt,name=feed,proto3" json:"feed,omitempty"`        // feed id
	Name     string `protobuf:"bytes,4,opt,name=name,proto3" json:"name,omitempty"`         // user name
	Image    string `protobuf:"bytes,5,opt,name=image,proto3" json:"image,omitempty"`       // user image
}
...
func (x *RegisterRequest) GetFeed() int64 {
	if x != nil {
		return x.Feed
	}
	return 0
...
type RegisterResponse struct {
	...
	UserName  string `protobuf:"bytes,2,opt,name=user_name,json=userName,proto3" json:"user_name,omitempty"`    // user name of the registered user
	UserImage string `protobuf:"bytes,3,opt,name=user_image,json=userImage,proto3" json:"user_image,omitempty"` // user image of the registered user
}
...
func (x *RegisterResponse) GetUserImage() string {
	if x != nil {
		return x.UserImage
	}
	return ""
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x65, 0x65, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x04, 0x66, 0x65, 0x65, 0x64, 0x12,
	0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e,
	0x61, 0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x05, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x22, 0x67, 0x0a, 0x10, 0x52, 0x65, 0x67,
	...
	0x67, 0x65, 0x22, 0x57, 0x0a, 0x0c, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x15, 0x5a, 0x13, 0x70, 0x6f, 0x70, 0x6b, 0x6f,
